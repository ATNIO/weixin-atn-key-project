; require('../../common.js'); var webpackJsonp = wx.webpackJsonp;webpackJsonp([2],{
...
var QR = __webpack_require__(107);
...
_tina.Page.define({
    ...
    onLoad: function onLoad(options) {
        ...
        if (this.data['inputContent'].length > 300) {
            ...
            var minimum = 2,
                shares = 3,
                raw = this.data.inputContent.toString('hex');
            var secretList = (0, _sssa.create)(minimum, shares, raw);
            for (var index = 0; index < secretList.length; index++) {
